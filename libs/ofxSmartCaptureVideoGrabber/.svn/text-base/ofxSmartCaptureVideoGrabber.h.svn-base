...
#ifndef _OFX_SMART_CAPTURE_VIDEO_GRABBER
#define _OFX_SMART_CAPTURE_VIDEO_GRABBER
...
class ofxSmartCaptureVideoGrabber : public ofBaseVideo{

	public :

		ofxSmartCaptureVideoGrabber();
		virtual ~ofxSmartCaptureVideoGrabber();
		...
		int			height;
		int			width;
		int         videoInputDevices; // stores the number of found devices -------------------------------------->  Added by Paulo Barcelos
