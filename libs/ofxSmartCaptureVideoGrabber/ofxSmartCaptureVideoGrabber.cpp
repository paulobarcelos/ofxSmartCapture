/* 
 *	Notice: this class is a slighy modified version of the original ofVideoGrabber (OF0061)
 *	It adds the public videoInputDevices member, used to store the number of found devices 
 *	after listDevices() is called;
 *	
 *	v0.01
...
//--------------------------------------------------------------------
ofxSmartCaptureVideoGrabber::ofxSmartCaptureVideoGrabber(){
...
ofxSmartCaptureVideoGrabber::~ofxSmartCaptureVideoGrabber(){
	...
	printf("closing ofxSmartCaptureVideoGrabber\n");
	close();
...
//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::listDevices(){
	...
	//---------------------------------
		...
		*/
		...
		videoInputDevices = deviceCount; // stores the number of found devices -------------------------------------->  Added by Paulo Barcelos
	...
	//---------------------------------
		ofLog(OF_LOG_NOTICE, "---");
		videoInputDevices = VI.listDevices(); // stores the number of found devices -------------------------------------->  Added by Paulo Barcelos
		ofLog(OF_LOG_NOTICE, "---");
...
//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::setVerbose(bool bTalkToMe){
	bVerbose = bTalkToMe;
...
//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::setDeviceID(int _deviceID){
	deviceID		= _deviceID;
	bChooseDevice	= true;
}

//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::setDesiredFrameRate(int framerate){
	attemptFramerate = framerate;
}

//---------------------------------------------------------------------------
unsigned char * ofxSmartCaptureVideoGrabber::getPixels(){
...
ofTexture & ofxSmartCaptureVideoGrabber::getTextureReference(){
	if(!tex.bAllocated() ){
		ofLog(OF_LOG_WARNING, "ofxSmartCaptureVideoGrabber - getTextureReference - texture is not allocated");
	}
	return tex;
}

//---------------------------------------------------------------------------
bool  ofxSmartCaptureVideoGrabber::isFrameNew(){
	return bIsFrameNew;
}

//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::update(){
	grabFrame();
}

//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::grabFrame(){
...
//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::close(){
...
//--------------------------------------------------------------------
void ofxSmartCaptureVideoGrabber::videoSettings(void){
...
//---------------------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::saveSettings(){
...
//---------------------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::loadSettings(){
   ...
   if (mySGVideoSettings){
      ...
      ofLog(OF_LOG_NOTICE, "No camera settings to load");
      return false;
   }
   return true;
}
...
//------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::qtInitSeqGrabber(){
...
//--------------------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::qtCloseSeqGrabber(){
...
//--------------------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::qtSelectDevice(int deviceNumber, bool didWeChooseADevice){
...
//--------------------------------------------------------------------
bool ofxSmartCaptureVideoGrabber::initGrabber(int w, int h, bool setUseTexture){
	...
	//---------------------------------
		...
		ofLog(OF_LOG_NOTICE,"end setup ofxSmartCaptureVideoGrabber");
		ofLog(OF_LOG_NOTICE,"-------------------------------------\n");
		...
		bail:
			...
			ofLog(OF_LOG_ERROR, "***** ofxSmartCaptureVideoGrabber error *****");
			ofLog(OF_LOG_ERROR, "-------------------------------------\n");
	...
	//--------------------------------
		...
		if(gstUtils.initGrabber(w,h,attemptFramerate)){
			...
			bGrabberInited = true;
			ofLog(OF_LOG_VERBOSE, "ofxSmartCaptureVideoGrabber: initied");
		}else{
			bGrabberInited = false;
			ofLog(OF_LOG_ERROR, "ofxSmartCaptureVideoGrabber: couldn't init");
		}
		return bGrabberInited;
...
//------------------------------------
void ofxSmartCaptureVideoGrabber::setUseTexture(bool bUse){
	bUseTexture = bUse;
}
...
//----------------------------------------------------------
void ofxSmartCaptureVideoGrabber::setAnchorPercent(float xPct, float yPct){
    if (bUseTexture)tex.setAnchorPercent(xPct, yPct);
}

//----------------------------------------------------------
void ofxSmartCaptureVideoGrabber::setAnchorPoint(int x, int y){
    if (bUseTexture)tex.setAnchorPoint(x, y);
}

//----------------------------------------------------------
void ofxSmartCaptureVideoGrabber::resetAnchor(){
   	if (bUseTexture)tex.resetAnchor();
}

//------------------------------------
void ofxSmartCaptureVideoGrabber::draw(float _x, float _y, float _w, float _h){
	if (bUseTexture){
...
//------------------------------------
void ofxSmartCaptureVideoGrabber::draw(float _x, float _y){
	draw(_x, _y, (float)width, (float)height);
}


//----------------------------------------------------------
float ofxSmartCaptureVideoGrabber::getHeight(){
	return (float)height;
}

//----------------------------------------------------------
float ofxSmartCaptureVideoGrabber::getWidth(){
	return (float)width;
}
